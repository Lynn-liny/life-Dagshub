...
# Attempts to initialize DagsHub for MLflow tracking. This is a global setup
# that should be done once at the app's entry point.
if MLFLOW_AVAILABLE:
    try:
...
DATA_FILE = os.path.join("Life Expectancy Data.csv") # Path to your data file within the 'data' folder
    ...
    try:
        if os.path.exists(DATA_FILE):
            ...
            st.warning(f"⚠️ Data file not found at '{DATA_FILE}'. "
                       "Please ensure it exists in your project's `data/` directory. "
